...
public class TestBase {
	...
	public TestBase(){
		try {
			p=new Properties();
			FileInputStream f=new FileInputStream("E:\\Supriya\\InHouse Project\\SN-POC\\src\\main\\java\\com\\sn\\Properties\\Config.properties" );
			p.load(f);
			;
		} catch (IOException e) {
	...
	public static void takeScreenshotAtEndOfTest() throws IOException {
		...
		String currentDir = System.getProperty("E:\\Supriya\\InHouse Project\\SN-POC");
